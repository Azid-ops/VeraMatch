          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:block">
              <div className="ml-4 flex items-center space-x-4">
                ...
                <Link href="/signup" className="bg-gradient-to-r from-pink-500 via-purple-500 to-blue-600 text-white px-8 py-3 rounded-full text-sm font-medium hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:shadow-pink-500/25">
                  Sign Up
                </Link>
              </div>
            </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to your VeraMatch account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-12 py-4 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all duration-300 bg-white/50 backdrop-blur-sm"
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="/forgot-password" className="font-medium text-pink-600 hover:text-pink-500 transition-colors duration-300">
                    Forgot password?
                  </a>
                </div>
              </div>
            ...
            <div className="mt-6 space-y-3">
              <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-200 rounded-xl text-gray-700 bg-white/50 backdrop-blur-sm hover:bg-gray-50 transition-all duration-300 group">
              ...
              <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-200 rounded-xl text-gray-700 bg-white/50 backdrop-blur-sm hover:bg-gray-50 transition-all duration-300 group">
                ...
                <span className="group-hover:translate-x-1 transition-transform duration-300">Continue with Twitter</span>
              </button>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600">
                ...
                <Link href="/signup" className="font-semibold text-pink-600 hover:text-pink-500 transition-colors duration-300">
                  Sign up for free
                </Link>
              </p>
            </div>
